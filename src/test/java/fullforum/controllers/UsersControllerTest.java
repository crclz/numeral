...
//        Assertions.assertEquals(model.username, userInDb.g);
//        Assertions.assertEquals(model.password, userInDb.getPassword());
    ...
    void patchUser_return_bad_request_when_model_invalid() throws Exception {
        var model = new PatchUserModel("o234a", "21313", "sadsdas");
    ...
    void patchUser_throw_unauthorized_when_not_login() {
        var model = new PatchUserModel("o234a6", "asdd", "asdasdasd");
    ...
    void patchUser_return_not_found_when_target_user_not_exist() {
        ...
        // Act & Assert
        var model = new PatchUserModel("o234a6", "2313123", "Dasdsdsd");
    ...
    void patchUser_throw_forbidden_when_target_user_is_not_self() {
        // Arrange
        auth.setRealUserId(1);
        var targetUser = new User(2, "asdasda", "asdsadsa", "sadasd", "ASdasdas");
        userRepository.save(targetUser);

        // Act & Assert
        var model = new PatchUserModel("o234a6", "sadas", "ASda");
    ...
    void patchUser_return_ok_and_changes_db_when_all_ok() {
        // Arrange
        auth.setRealUserId(1);
        var targetUser = new User(1, "asdasda", "asdsadsa", "ASdad", "ASdasd");
        userRepository.save(targetUser);

        // Act
        var model = new PatchUserModel("o234a6", "ASdsada", "ASDdasdas");
    ...
    void getUserById_return_user_info_when_user_exist() {
        // Arrange
        var userEntity = new User(1, "asda", "sdsdasdasdsa", "ASdsad", "ASdasd");
